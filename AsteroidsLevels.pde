...
class AsteroidsLevel1 extends AsteroidsGameLevel 
{
  ...
  void drawOnScreen() 
  {
    ...
    text(msg, 10, 80);
    msg = "Remaining lives: " + remainingLives;
    text(msg, 10, 100);
...
class AsteroidsLevel3 extends AsteroidsGameLevel 
{
  ...
  void start()
  {
    ...
    asteroids.add(new BigAsteroid(game, 100, 300, 2, 0.01, 22, PI*1.7));
    asteroids.add(new BigAsteroid(game, 500, 600, 0, -0.02, 22, PI*1.3));
    asteroids.add(new BigAsteroid(game, 650, 400, 1, -0.01, 22, PI*1));
    asteroids.add(new BigAsteroid(game, 780, 460, 2, 0.01, 22, PI*1.7));
    asteroids.add(new BigAsteroid(game, 500, 280, 0, -0.02, 22, PI*1.3));
